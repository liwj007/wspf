  ...
  <div style="height: 100%;">
    <div class="com-inner-content">
      <Row class="title-div title-font">
        <Col span="24" class="">历史申请记录列表</Col>
    ...
    <Modal
      ...
      <Form  :label-width="80" label-position="left">
        ...
        <Form-item label="是否面试">
          ...
          <p v-else-if="detail.interviewStatus === 'SEND'">是</p>
          <p v-else>否</p>
        </Form-item>
...
<script>
  export default {
          ...
          },
          {
            ...
            render: (h, params) => {
              if (params.row.interviewStatus === 'SEND' && params.row.interviewResult === 'NONE') {
                ...
                return h('span', '通过')
              } else if (params.row.interviewResult === 'FAIL') {
                return h('span', '拒绝')
              } else {
                return h('span', '-')
              }
    ...
    methods: {
      ...
      getMyAllApplications: function () {
        this.$http.get('/applications/myself/all', {
          params: {
            page: this.page - 1,
